...
class AccountMove(models.Model):
    ...
    filiere_id = fields.Many2one('siantou.ems.core.field_of_study', compute='_compute_school_accounting_axes', readonly=False, store=True)
    ...
    niveau_id = fields.Many2one('siantou.ems.core.level', compute='_compute_school_accounting_axes', readonly=False, store=True)
    ...
    def _compute_school_accounting_axes(self):
        for rec in self:
            if rec.statement_line_id:
                ...
                rec.filiere_id = rec.statement_line_id.filiere_id
                ...
                rec.niveau_id = rec.statement_line_id.niveau_id
