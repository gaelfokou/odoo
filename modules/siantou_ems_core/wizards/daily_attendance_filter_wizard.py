...
class DailyAttendanceFilterWizard(models.TransientModel):
    ...
    def action_filter(self):
        ...
        if self.start_punching_day and self.end_punching_day:
            datetime_before = DailyAttendanceFilterWizard.convert_datetime_from_utc(self.start_punching_day)
            datetime_after = DailyAttendanceFilterWizard.convert_datetime_from_utc(self.end_punching_day)
            start_punching_day = datetime.strftime(datetime_before, DATETIME_FORMAT_FR)
            end_punching_day = datetime.strftime(datetime_after, DATETIME_FORMAT_FR)
            title.append('Date')
        ...
        if self.start_punching_time and self.end_punching_time:
            datetime_before = DailyAttendanceFilterWizard.convert_datetime_from_utc(self.start_punching_time)
            datetime_after = DailyAttendanceFilterWizard.convert_datetime_from_utc(self.end_punching_time)
            start_punching_time = datetime.strftime(datetime_before, DATETIME_FORMAT_FR)
            end_punching_time = datetime.strftime(datetime_after, DATETIME_FORMAT_FR)
